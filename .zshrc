...
# The default text editor to use
export VISUAL="vim"
...
alias tgeth="geth --datadir ~/Ethereum/TestNetwork1 --networkid 15"
# alias dev-torus="~/Programming/go/src/github.com/mroseman95/torus-cli/torus-cli"

# setup the Node Version Manager
